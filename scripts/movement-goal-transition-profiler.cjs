...
function snapshot(){return{version:'1.0',counts:Object.assign({},counts),transitions:top(transitions,40),samples:samples.slice()};}
...
wrap();
root.BattleMovementGoalTransitionProfiler={version:'1.0',reset:reset,snapshot:snapshot,restore:restore};
