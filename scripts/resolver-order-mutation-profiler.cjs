...
function snapshot(){return{version:'1.0',counts:Object.assign({},counts),samples:samples.slice()};}
...
root.BattleResolverOrderMutationProfiler={version:'1.0',reset:reset,snapshot:snapshot,restore:restore};
