...
STATIC_FILES = [
    ...
    ("labs/save-calibration.php", "labs/save-calibration.php"),
]
...
# Committed per-model sidecar calibrations (*.json) ship the same way; ones tuned on the
# server are never managed here, so deploys can neither upload nor delete them.
SOLDIER_ASSET_GLOBS = [("Assets/soldiers", "*.fbx"), ("Assets/soldiers", "*.json"), ("Assets/animations", "*.fbx"),
                       ("Assets/weapons", "*.fbx"), ("Assets/effects/muzzle-flash", "*.png")]
