...
for(const type of typeOrder){const t=battleTypes[type],i=t.issueCounts;md.push(`| ${type} | ${t.completedBattles} | ${t.winners.us}/${t.winners.ge} | ${t.health.overall} | ${t.health.strategic} | ${t.health.movement} | ${t.health.cohesion} | ${t.health.objective} | ${i.routeStalls} | ${i.movementStalls} | ${i.writerConflicts} | ${i.loopAlerts} | ${t.avgNoObjectiveProgressSeconds}s |`);}
