<?php
/* 50webs production entrypoint for the Battle Sim / ww2fps AI laboratory v21.
   v21 identifies the per-match checkpoint/resource-reset trainer so performance testing can be
   distinguished from the older accumulating v20 training runtime. Runtimes are separate
   cache-busted files and battle/modules/*.js are discovered automatically.
...
header('Pragma: no-cache');header('Expires: 0');header('Surrogate-Control: no-store');header('X-Grasstex-Source: modular-ai-lab-v21');
...
header('X-Grasstex-Deploy-Id: '.$deployId);header('X-Grasstex-Build: v21');header('X-Grasstex-Modules: '.count($moduleFiles));echo $body;
?>
