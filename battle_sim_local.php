<?php
/* 50webs production entrypoint for the Battle Sim / ww2fps AI laboratory v20.
   Runtimes are separate cache-busted files. battle/modules/*.js are discovered automatically.
...
header('Pragma: no-cache');header('Expires: 0');header('Surrogate-Control: no-store');header('X-Grasstex-Source: modular-ai-lab-v20');
...
header('X-Grasstex-Deploy-Id: '.$deployId);header('X-Grasstex-Build: v20');header('X-Grasstex-Modules: '.count($moduleFiles));echo $body;
?>
