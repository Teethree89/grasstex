<?php
/* 50webs production entrypoint for the Battle Sim / ww2fps AI laboratory v24.
   v24 embeds baked soldier motion tracks in soldier.js, avoiding a separately deployed asset.
...
header('Pragma: no-cache');header('Expires: 0');header('Surrogate-Control: no-store');header('X-Grasstex-Source: modular-ai-lab-v24');
...
header('X-Grasstex-Deploy-Id: '.$deployId);header('X-Grasstex-Build: v24');header('X-Grasstex-Modules: '.count($moduleFiles));echo $body;
?>
