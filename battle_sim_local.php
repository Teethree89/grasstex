<?php
/* 50webs production entrypoint for the Battle Sim / ww2fps AI laboratory v28.
   v28 plays rig-local package tracks and keeps both hands on the weapon with arm IK.
...
$cameraPattern='#  var target=new BABYLON\.Vector3\(scenario\.center\.x,4,scenario\.center\.z\),camera=new BABYLON\.ArcRotateCamera[\s\S]*?console\.log\(\'\[CAMERA\] v28 WASD pan enabled\'\);#';
...
$preCommander=array('camera-controls.js','acoustics.js','scenario-generator.js','battle-navigation.js','town-objectives.js','module-registry.js','ai-policy.js','objective-system.js','battle-telemetry.js','commander-ai.js');$extras='';foreach($preCommander as $file)$extras.='<script src="/grasstex/battle/'.$file.'?v='.$deployId.'"></script>'."\n";
...
header('X-Grasstex-Deploy-Id: '.$deployId);header('X-Grasstex-Build: v28');header('X-Grasstex-Modules: '.count($moduleFiles));echo $body;
?>
