<?php
/* 50webs production entrypoint for the Battle Sim / ww2fps AI laboratory v25.
   v25 corrects package walk-arm retargeting and bumps every runtime URL.
...
header('Pragma: no-cache');header('Expires: 0');header('Surrogate-Control: no-store');header('X-Grasstex-Source: modular-ai-lab-v25');
...
header('X-Grasstex-Deploy-Id: '.$deployId);header('X-Grasstex-Build: v25');header('X-Grasstex-Modules: '.count($moduleFiles));echo $body;
?>
