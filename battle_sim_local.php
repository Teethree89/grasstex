...
$coreScripts=array('soldier-animations.js','soldier.js','weapons.js','terrain-features.js','squad-ai.js','battle-sim.js');foreach($coreScripts as $file){$old='<script src="'.$file.'"></script>';$new='<script src="/grasstex/battle/'.$file.'?v='.$deployId.'"></script>';$body=str_replace($old,$new,$body);}
