...
(function(root){
  ...
  root.BattleVacantObjectiveAssault={version:'67-vacant-objective-query',immediateThreat:IMMEDIATE_THREAT,isVacantEnemyObjective:isVacantEnemyObjective};
  if(typeof console!=='undefined')console.log('[COMMAND] vacant enemy-owned objectives inform Force Command missions');
