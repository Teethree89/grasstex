...
root.BattleEngagement.updateSoldier=function(s,b){var result=oldUpdate.apply(this,arguments);if(!s||!b||s.dead)return result;var e=estate(s);if(!maintainUrgent(s,b,e)&&(+s.suppressedUntil||0)>b.time&&['pinned','engage','orient'].indexOf(String(e.state||''))>=0)startUrgent(s,b,e);reactShared(s,b,e);return result;};
